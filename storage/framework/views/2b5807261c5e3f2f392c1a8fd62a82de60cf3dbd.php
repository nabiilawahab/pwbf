                        ...
                        <div class="row">
                            <div class="col-xl-7 col-lg-9 col-md-10 col-sm-9">
                                <div class="hero__caption">
                                    <h1 data-animation="fadeInLeft" data-delay="0.2s">Laundry Sepatu Berkualiatas</h1>
        ...
        <section class="offer-services pb-bottom2">
            <div class="container">
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single-offers">
                            <img src="assets/images/offers2.png" alt="" class=" w-100">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="about-caption mb-50">
                            ...
                            <p class="mb-20">
                            Barokah laundry Shoes berdiri sejak tahun 2018 
kami mengerjakan dengan sepenuh hati, agar customer happy
                            </p>
            ...
            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
                <div class="single-footer-caption mb-50">
                    <div class="footer-tittle">
                        <h4>Get in touch</h4>
                        <ul>
                            <li class="number"><a href="#">(+62)82229432819 </a></li>
...
</html><?php /**PATH C:\xampp\htdocs\Laravel\test-app\resources\views/tampilan.blade.php ENDPATH**/ ?>